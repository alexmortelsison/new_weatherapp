    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final currentTemp = temperature.toInt();
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: currentSky == 'Clouds' ||
                                        currentSky == 'Rain'
                                    ? const Image(
                                        image: AssetImage('images/cloudy.gif'))
                                    : const Image(
                                        image: AssetImage(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return HourlyForecastItem(
                        ...
                        image: hourlySky == 'Clouds' || hourlySky == 'Rain'
                            ? const AssetImage('images/cloudy.gif')
                            : const AssetImage('images/final_sunny.gif'),
                      );
                    },
                  ),
                ),
